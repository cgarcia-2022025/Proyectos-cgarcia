...
import { encrypt, checkPassword, checkUpdateStudent, checkUpdateTeacher  } from '../utils/validator.js'
...
export const updateSt = async(req, res)=>{ //Datos generales (No password)
    try{
...
export const updateTh = async(req, res)=>{ //Datos generales (No password)
    try{
        //Obtener el id del usuario a actualizar
        let { id } = req.params
        //Obtener los datos a actualizar
